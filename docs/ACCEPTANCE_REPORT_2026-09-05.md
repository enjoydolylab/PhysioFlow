...
- Block randomization was checked against an independent exhaustive feasibility oracle across 960 condition-count/limit combinations. Impossible constraints now produce validation errors instead of silently relaxing. Fractional Block/Trial repeats are rejected.

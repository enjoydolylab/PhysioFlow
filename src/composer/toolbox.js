...
export const VALIDATION_MESSAGES_JA = {
  ...
  'node.id_missing': 'ノードIDがありません',
  'node.id_duplicate': 'ノードIDが重複しています',
  'node.component_missing': 'ノードのコンポーネント種別がありません',
  'edge.source_direction': '接続元の向きが正しくありません（出力ポートから出る必要があります）',
  'edge.target_direction': '接続先の向きが正しくありません（入力ポートへ向かう必要があります）',
  'variable.name_missing': '変数名を入力してください',
  'variable.name_duplicate': '変数名が重複しています',
  'variable.type_invalid': '変数の型が無効です',
  'variable.scope_invalid': '変数のスコープが無効です',
  'group.name_missing': 'グループ名を入力してください',
  'group.empty': 'グループが空です',
  'group.node_missing': 'グループ内のノードが見つかりません',
  'group.node_multiple': '1つのノードは1つのグループにのみ所属できます',
  'subflow.parameter_mapping_missing': 'サブフローのパラメータ対応がありません',
  'subflow.parameter_mapping_type_mismatch': 'サブフローのパラメータ対応の型が一致しません',
  'subflow.template_empty': 'サブフローのテンプレートが空です',
  'subflow.entry_invalid': 'サブフローの入口ノードが無効です',
  'subflow.exit_invalid': 'サブフローの出口ノードが無効です',
  'sdk.permission_unapproved': 'SDKの権限が承認されていません',
  'sdk.permission_variable_read': 'SDKに変数の読み取り権限がありません',
  'sdk.permission_network_media': 'SDKにネットワークメディアの権限がありません',
  'sdk.permission_asset_read': 'SDKにアセットの読み取り権限がありません',
  'device.connector_missing': 'デバイスコネクタがインストールされていません',
  'device.connector_invalid': 'デバイスコネクタが無効です',
  'device.permission_unapproved': 'デバイスの権限が承認されていません',
  'config.stimulus_pool_inconsistent': '旧形式の埋め込み刺激プール設定が一致していません',
  'config.ui_variable_missing': '画面のバインディングが存在しない変数を参照しています',
  'config.condition_operator_invalid': '条件演算子が無効です',
  'config.loop_until_operator_invalid': 'ループ終了条件の演算子が無効です',
  'config.fixation_shape_invalid': '注視点の形状が無効です',
  'config.cognitive_task_kind_invalid': '認知課題の種類が無効です',
  'config.cognitive_task_trials_empty': '認知課題に試行がありません。先に生成してください',
  'config.cognitive_task_trial_id_invalid': '認知課題の試行IDが無効です',
  'config.cognitive_task_timing_invalid': '認知課題の試行時間が無効です',
  'config.migration.review_required': '移行後に設定を確認してください',
};

...
**研究室候補版（2026-09-24）**：v0.6.0-beta.6。設計・準備・テスト・凍結実行・データ出力の基本フローを収録しています。445 件のテスト、ビルド、Lint、3 種類のブラウザテストが通過しました。原動画・実機・実際の PhysioDB による最終検証は未完了です。

## ダウンロード

[v0.6.0-beta.6 リリース](https://github.com/enjoydolylab/PhysioFlow/releases/tag/v0.6.0-beta.6) から Windows x64 インストーラー、Web ZIP、SHA-256 を取得してください。[変更点・使用手順・未検証項目](docs/RELEASE_NOTES_beta.6.md)を必ず確認してください。
